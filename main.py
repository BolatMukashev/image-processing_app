...
PROMPT = """Создай изображение по дизайн стилю.
на изображении будет две одинаковые визитки (размер визиток 9х5 см) но на разных языках. на русском с текстом:
Фирма "Saya Decor Astana"

- Ролл-шторы: Мини, Стандарт, Зебра 
- Шторы-плиссе
...
+77027291710 WhatsApp 
+77773291710

на казахском с текстом:
"Saya Decor Astana"Фирмасы

- Роликті перделер: шағын, стандартты, Зебра 
- Перделер
- Тік, көлденең перделер

Меншікті өндіріс 

Мінсіз баға-сапа қатынасы

Тапсырыстарды орындаудың қысқа мерзімдері
